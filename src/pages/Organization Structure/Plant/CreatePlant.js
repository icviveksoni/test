                ...
                <div className='row'>
                    <div className='col-12'>
                        ...
                        <div className='main-menu'>
                            <div className='heading'>Create Plant</div>
                            <div className='container-fluid'>
                                <div className='row details pb-4 mt-3'>
                                    <div className='col-lg-3 col-md-6 col-12'>
                                        <label for="fname">Company<sup style={{ color: 'red' }}>*</sup></label><br />
                                    ...
                                    <div className='col-lg-3 col-md-6 col-12 mt-3'>
                                        <label for="fname">Batch Type</label><br />
                                        <input className='w-100' type="text" id="fname" name="fname" />
                                    </div>
                                    <div className='col-lg-3 col-md-6 col-12 mt-3'>
                                        <label for="fname">Plant Type</label><br />
                                        <input className='w-100' type="text" id="fname" name="fname" />
                                    </div>
