...
const MiscExpense = () => {
  ...
  const [name, setName] = useState("Misc Expenses");
  const [under, setUnder] = useState("Primary");
  const [quantitiesAdded, setQuantitiesAdded] = useState("No");
  const [natureOfGroup, setNatureOfGroup] = useState('Assets');
  ...
  const [positionIndex, setPositionIndex] = useState('80');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">Misc Expenses</div>
