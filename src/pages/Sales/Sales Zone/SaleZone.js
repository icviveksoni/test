                    ...
                    <div className='col-12'>
                        ...
                        <div className='main-menu'>
                            <div className='d-flex justify-content-between' style={{borderBottom:'1px solid #dfdfdf'}}>
                                <div className='heading'>Sales Zones</div>
                                <div><Link to="/create-sale-zone"><button type="button" class="btn btn-primary" style={{backgroundColor:'#3c8dbc'}}>Create Sales Zone</button></Link></div>
                            </div>
                                <div className='container-fluid'>
                                    <div className='row'>
                                        <div className='col-12'>
