...
const LoansLiability = () => {
  // State for each field
  const [name, setName] = useState("Loans (Liability)");
  const [under, setUnder] = useState("Primary");
  const [quantitiesAdded, setQuantitiesAdded] = useState("No");
  const [natureOfGroup, setNatureOfGroup] = useState('Liability');
  ...
  const [positionIndex, setPositionIndex] = useState('20');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">Loans (Liability)</div>
