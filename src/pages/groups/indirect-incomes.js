...
const InDirectIncome = () => {
  ...
  const [name, setName] = useState("InDirect Income");
  const [under, setUnder] = useState("Primary");
  const [quantitiesAdded, setQuantitiesAdded] = useState("No");
  const [natureOfGroup, setNatureOfGroup] = useState('Income');
  ...
  const [positionIndex, setPositionIndex] = useState('270');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">InDirect Income</div>
