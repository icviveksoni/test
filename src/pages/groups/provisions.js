...
const Provisions = () => {
  ...
  const [name, setName] = useState("Provisions");
  const [under, setUnder] = useState("Current Liabilities");
  ...
  const [positionIndex, setPositionIndex] = useState('150');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">Provisions</div>
