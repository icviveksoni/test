...
const CapitalAccount = () => {
  ...
  const [positionIndex, setPositionIndex] = useState('10');
        ...
        <div className="row">
           <div className="col-12">
              <div className="main-menu">
                  <div className="heading">Capital Account</div>
                    <div className="row mt-3">
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mt-3 d-flex justify-content-between">
                        <span className="label font-bold ">Nature of Group:</span>
            <select
              value={natureOfGroup}
