...
const PurchaseAccount = () => {
  ...
  const [name, setName] = useState("Purchase Accounts");
  const [under, setUnder] = useState("Primary");
  const [quantitiesAdded, setQuantitiesAdded] = useState("No");
  const [natureOfGroup, setNatureOfGroup] = useState('Expenses');
  ...
  const [positionIndex, setPositionIndex] = useState('240');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">Purchase Accounts</div>
                <div className="row mt-3">
                    ...
                    <div className="col-lg-4 col-md-6 col-12  offset-lg-1 d-flex justify-content-between">
                        <label className="my-auto">Under </label>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-3  d-flex justify-content-between">
                        <span className="label font-bold ">Nature of Groups</span>
            <select
              value={natureOfGroup}
            ...
            >
              ...
              <option value="Expenses">Expenses</option>
                        ...
                        <span className="label font-bold ">Does it affect gross profit </span>
            <select
              value={groupBehavior}
