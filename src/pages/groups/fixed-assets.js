...
const FixedAsset = () => {
  ...
  const [name, setName] = useState("Fixed Assets");
  const [under, setUnder] = useState("Primary");
  const [quantitiesAdded, setQuantitiesAdded] = useState("No");
  const [natureOfGroup, setNatureOfGroup] = useState('Asset');
  ...
  const [positionIndex, setPositionIndex] = useState('40');
      ...
      <div className="row">
        <div className="col-12">
            <div className="main-menu">
                <div className="heading">Fixed Assets</div>
