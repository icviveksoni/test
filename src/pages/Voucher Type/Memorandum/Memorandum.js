        ...
        <div className='row'>
            <div className='col-12'>
                <div className='main-menu'>
                    <div className='heading'>Memorandum</div>
                    <div className='row'>
                        <div className='col-12'>
                    ...
                    <div className='row mt-4'>
                        ...
                        <div className='col-lg-4 col-md-6 col-12 d-flex justify-content-between'>
                            ...
                            <input type="text" id="fname" name="fname" value="Memorandum"/>
                        </div>
                        ...
                        <div className='col-lg-4 col-md-6 col-12 mt-2 d-flex justify-content-between'>
                            <label className='my-auto' for="cars">Activate This Voucher Type</label>
                            <select name="cars" id="cars">
                        ...
                        <div className='col-lg-4 col-md-6 col-12 mt-2 d-flex justify-content-between'>
                            <label className='my-auto' for="cars">Provide narration for each ledger in voucher</label>
                            <select name="cars" id="cars">
                                <option value="volvo">Yes</option>
                                <option value="saab">No</option>
                            </select>
                        ...
                        <div className='col-lg-4 col-md-6 col-12 offset-lg-1 mt-2 d-flex justify-content-between'>
                            <label className='my-auto' for="cars">Track Additional Costs for Purchases</label>
                            <select name="cars" id="cars">
                                <option value="volvo">Yes</option>
                                <option value="saab">No</option>
                            </select>
