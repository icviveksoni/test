        ...
        <div className='row'>
            <div className='col-12'>
                <div className='main-menu'>
                    <div className='heading'>Sales Journal</div>
                    <div className='row'>
                        <div className='col-12'>
                    ...
                    <div className='row mt-4'>
                        ...
                        <div className='col-lg-4 col-md-6 col-12 d-flex justify-content-between'>
                            ...
                            <input type="text" id="fname" name="fname" value="Sales Journal"/>
                        </div>
                        ...
                        <div className='col-lg-4 col-md-6 col-12 offset-lg-1 mt-2 d-flex justify-content-between'>
                            <label className='my-auto' for="cars">Use as a Manufacturing Journal</label>
                            <select name="cars" id="cars">
                                <option value="volvo">Yes</option>
                                <option value="saab">No</option>
                            </select>
